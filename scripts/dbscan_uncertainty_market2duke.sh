...
python3 sbs_traindbscan.py -tt dukemtmc -st market1501 -a resnet50_multi_sbs -m uncertainty\
	...
	--logs-dir logs/dbscan-market1501TOdukemtmc/resnet50_multi_sbs_mb_uncertainty
