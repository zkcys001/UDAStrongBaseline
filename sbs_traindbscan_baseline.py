...
def main_worker(args):
    ...
    source_features, _,_ = extract_features(model_1, sour_cluster_loader, print_freq=50)
    ...
    for epoch in range(len(clusters)):
        ...
        if epoch % 6 == 0 and epoch != 0:
            target_features_dict, _ ,prob= extract_features(model_1_ema, tar_cluster_loader, print_freq=50)
