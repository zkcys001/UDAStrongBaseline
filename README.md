...
- `Direct infer` models are trained on the source-domain datasets ([source_pretrain]()) and directly tested on the target-domain datasets. `GLT` denotes to the implementation of our CVPR-2021 and [`uncertainty`](https://arxiv.org/abs/2012.08733) denotes to the implementation of our AAAI-2021. 
...
| [Our stronger_baseline + uncertainty (DBSCAN)](https://arxiv.org/abs/2012.08733) | ResNet50 | DukeMTMC | 80.5 | 93.0 | 97.3 | 98.2 | ~5h |
...
| [Our stronger_baseline + uncertainty (DBSCAN)](https://arxiv.org/abs/2012.08733) | ResNet50 | Market1501 | 70.3 | 82.7 | 90.8 | 93.1 | ~5h |
